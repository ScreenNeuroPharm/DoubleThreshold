function hFig = plplot(x, xmin, alpha, type)
...
switch f_dattype,
    ...
    case 'REAL',
        ...
        if ~strcmp('',string), title(string,'FontSize',16); end;
        ylabel('Pr(X \geq x)','FontSize',16);
        xlabel('x','FontSize',16)
        legend('data',['alpha = -',num2str(alpha),'; xmin = ',num2str(xmin)])
